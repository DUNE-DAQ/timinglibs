...
local cs = {
  ...
  timing_hardware_interface: s.record("timing_hardware_interface", [
    s.field('firmware_type',              self.firmware_type, default='pdi',       doc="Timing firmware type, pdi (NRZ) or pdii (no cdr)"),
    ...
    s.field('port_thi',                   daqconf.Port,       default=12345,       doc='Port to host running the (global) timing hardware interface app on'),
