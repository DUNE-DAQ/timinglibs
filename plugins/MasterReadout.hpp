...
#ifndef TIMINGLIBS_PLUGINS_MASTERREADOUT_HPP_
#define TIMINGLIBS_PLUGINS_MASTERREADOUT_HPP_
...
/**
 * @brief MasterReadout generates fake HSIEvent messages
 * and pushes them to the configured output queue.
 */
class MasterReadout : public dunedaq::appfwk::DAQModule
{
public:
  /**
   * @brief MasterReadout Constructor
   * @param name Instance name for this MasterReadout instance
   */
  explicit MasterReadout(const std::string& name);

  MasterReadout(const MasterReadout&) = delete;            ///< MasterReadout is not copy-constructible
  MasterReadout& operator=(const MasterReadout&) = delete; ///< MasterReadout is not copy-assignable
  MasterReadout(MasterReadout&&) = delete;                 ///< MasterReadout is not move-constructible
  MasterReadout& operator=(MasterReadout&&) = delete;      ///< MasterReadout is not move-assignable
...
#endif // TIMINGLIBS_PLUGINS_MASTERREADOUT_HPP_
